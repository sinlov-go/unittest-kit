# This dockerfile uses extends image https://hub.docker.com/sinlov-go/unittest-kit
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/unittest-kit
ARG GO_ENV_ROOT_BUILD_BIN_NAME=unittest-kit
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/unittest-kit/main.go
...
ENTRYPOINT [ "/app/unittest-kit" ]
# CMD ["/app/unittest-kit", "--help"]